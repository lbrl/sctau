...
/// SCTau specific ECAL calorimeter implementation
///
/// SCTauECAL inherits from calorimeter class and must implement
/// clusterSize/acceptance/energyResolution etc methods
class SCTauECAL : public Calorimeter {
 ...
 public:
   ...
   *
   ...
   @param[in] eres energy resolution parameters for barrel and endcap,
              default {{4.22163e-02, 1.55903e-01, 7.14166e-03},
                       {-2.08048e-01, 3.25097e-01, 7.34244e-03}},
   @param[in] eresp energy response parameters for barrel and endcap,
              defaults to {{1.00071, -9.04973, -2.48554},
                           {9.95665e-01, -3.31774, -2.11123}});
   */
  SCTauECAL(double innerRadius = 1.3,
          double innerZ = 2,
          ...
          const std::vector<std::vector<double>> eres =
              {{ 4.22163e-02, 1.55903e-01, 7.14166e-03},
               {-2.08048e-01, 3.25097e-01, 7.34244e-03}},
          const std::vector<std::vector<double>> eresp =
              {{1.00071,     -9.04973, -2.48554},
               {9.95665e-01, -3.31774, -2.11123}});
  ...
  /** Energy response for SCTau ECAL
   */
