...
/// SCTau specific implementation of  HCAL Detector element
///
class SCTauHCAL : public Calorimeter {
public:
  /** Constructor
   *
   ...
   6.676, 0.1716}}
   @param[in] eresp energy response parameters for barrel and endcap, defaults to {{1.036, 4.452, -2.458}, {1.071,
   9.471,
   -2.823}}
   ...
   5., 7. }
   */
  SCTauHCAL(double innerRadius = 1.9,
          double innerZ = 2.6,
...
private:
  ...
  std::vector<double> m_acceptanceParameters;  ///< list of parameters used in SCTau acceptance
};
