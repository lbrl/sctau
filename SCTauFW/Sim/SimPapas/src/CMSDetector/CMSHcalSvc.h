...
class CMSHcalSvc : public extends1<Service, IPapasCalorimeterSvc> {
    ...
    Gaudi::Property<double> m_innerRadius{this,
        "innerRadius", 1.9, "Hcal inner radius"};
    Gaudi::Property<double> m_innerZ{this,
        "innerZ", 2.6, "Hcal inner z"};
    Gaudi::Property<double> m_outerRadius{this,
        "outerRadius", 2.9, "Hcal outer radius"};
    Gaudi::Property<double> m_outerZ{this,
        "outerZ", 3.6, "Hcal outer Z"};
...
inline std::shared_ptr<papas::Calorimeter> CMSHcalSvc::calorimeter() const {
    return m_hcal;
}
