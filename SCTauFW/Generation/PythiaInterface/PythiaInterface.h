...
class PythiaInterface : public GaudiTool, virtual public IHepMCProviderTool {
    ...
    /// Name of Pythia configuration file with Pythia simulation settings &
    /// input LHE file (if required)
    Gaudi::Property<std::string> m_parfile{this,
        "Filename", "Generation/data/Pythia_minbias_pp_100TeV.cmd"
    ...
    DataHandle<fcc::FloatValueCollection> m_handleMePsMatchingVars{
        "mePsMatchingVars", Gaudi::DataHandle::Writer, this};
