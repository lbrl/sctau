...
GenMerge::GenMerge(const std::string& name, ISvcLocator* svcLoc) :
    GaudiAlgorithm(name, svcLoc) {
    declareProperty("signalGenParticles", m_partInSignal,
                    "Generated signal particle collection (input)");
    declareProperty("signalGenVertices", m_vertInSignal,
                    "Generated signal vertex collection (input)");
    declareProperty("pileupGenParticles", m_partInPileUp,
                    "Generated pileup particle collection (input)");
    declareProperty("pileupGenVertices", m_vertInPileUp,
                    "Generated pileup vertex collection (input)");
    declareProperty("allGenParticles", m_partOut,
                    "Merged particle collection (output)");
    declareProperty("allGenVertices", m_vertOut,
                    "Merged vertex collection (output)");
}
