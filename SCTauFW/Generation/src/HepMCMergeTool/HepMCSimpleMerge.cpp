...
HepMCSimpleMerge::HepMCSimpleMerge(const std::string& type,
...
StatusCode HepMCSimpleMerge::merge(HepMC::GenEvent& signalEvent,
                        const std::vector<HepMC::GenEvent>& eventVector) {
